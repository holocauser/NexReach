          ...
          <View style={styles.optionsContainer}>
            ...
            {Platform.OS !== 'web' && (
              <TouchableOpacity 
                ...
                disabled={loading}
              >
                <Camera size={24} color={loading ? Colors.textLight : Colors.primary} />
            ...
            <TouchableOpacity 
              ...
              disabled={loading}
            >
              <ImageIcon size={24} color={loading ? Colors.textLight : Colors.primary} />
              <View style={styles.optionTextContainer}>
                <Text style={[styles.optionText, loading && styles.optionTextDisabled]}>
                  {Platform.OS === 'web' ? 'Choose File' : 'Choose from Library'}
                </Text>
                <Text style={styles.optionSubtext}>
                  {Platform.OS === 'web' 
              ...
              {loading && <ActivityIndicator size="small" color={Colors.primary} style={styles.optionLoader} />}
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
