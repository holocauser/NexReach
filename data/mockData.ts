...
export const mockCards: BusinessCard[] = [
  {
    ...
    phone: '(555) 123-4567',
    email: 'sjohnson@northsidemed.com',
    address: '123 Medical Parkway, Suite 300, Atlanta, GA 30328',
    website: 'www.northsidemed.com/sjohnson',
    specialty: ['Orthopedics', 'Sports Medicine'],
    languages: ['English', 'Spanish'],
    tags: ['Sports Injuries', 'Knee Specialist', 'Spanish-speaking'],
    ...
    files: [{ name: 'Resume.pdf', url: 'https://example.com/resume.pdf' }]
  },
  {
    id: '2',
    ...
    website: 'www.martinezlaw.com',
    specialty: ['Personal Injury', 'Workers Compensation'],
    languages: ['English', 'Spanish'],
    tags: ['PI Attorney', 'Spanish-speaking', 'Workers Comp'],
    favorited: false,
  ...
  },
  {
    ...
    title: 'Neurosurgeon',
    phone: '(555) 456-7890',
    email: 'mlee@atlantaspine.com',
    address: '2525 Piedmont Rd, Suite 350, Atlanta, GA 30305',
    specialty: ['Neurosurgery', 'Spine Surgery'],
    languages: ['English', 'Mandarin'],
    tags: ['Spine Specialist', 'Minimally Invasive'],
  ...
  },
  {
    ...
    address: '1100 Spring St NW, Atlanta, GA 30309',
    specialty: ['Medical Malpractice', 'Healthcare Law'],
    languages: ['English'],
    tags: ['Med Mal', 'Healthcare Law'],
    lastContacted: new Date('2023-04-20'),
    reminder: true,
    favorited: false,
  ...
  },
  {
    ...
    company: 'Atlanta Pain Specialists',
    title: 'Pain Management Physician',
    phone: '(555) 234-5678',
    email: 'jkim@atlpain.com',
    address: '2140 Peachtree Rd, Suite 500, Atlanta, GA 30318',
    specialty: ['Pain Management', 'Anesthesiology'],
    languages: ['English', 'Korean'],
    tags: ['Pain Management', 'Korean-speaking', 'Accepts Medicare'],
    lastContacted: new Date('2023-07-05'),
    reminder: false,
    favorited: true,
